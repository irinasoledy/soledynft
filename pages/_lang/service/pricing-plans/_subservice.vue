    ...
    <v-container v-if="service" class="pricing-plans">
      <v-row class="ip-plan-row">
        ...
        <v-tabs class="pricing-plans-tabs" centered dark>
          ...
          <v-tab :to="`/${language.lang}/service/pricing-plans/${service.alias}`">
                ...
                <template v-slot:default>
                  ...
                  <tr v-for="(child, index) in anchor.children" :key="index">
                    ...
                    <td>
                      ...
                      <span
                          v-if="child.translation.package_1 !== 'AddPrice' && child.translation.package_1 !== 'No' && child.translation.package_1 !== 'Yes'">
                    ...
                    <td>
                      ...
                      <span
                          v-if="child.translation.package_2 !== 'AddPrice' && child.translation.package_2 !== 'No' && child.translation.package_2 !== 'Yes'">
                    ...
                    <td>
                      ...
                      <span
                          v-if="child.translation.package_3 !== 'AddPrice' && child.translation.package_3 !== 'No' && child.translation.package_3 !== 'Yes'">
