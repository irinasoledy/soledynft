    ...
    <div class="row expert-one-content" v-if="service">
      ...
      <!-- <div class="col-lg-3 col-md-4">
        <v-list class="list-expert-one">
          ...
          <v-list-item active-class="active-anchor" v-for="(item, i) in items" :key="i" :href="'#' + item.toString().toLowerCase().replace(/ /g,'')" >
            <v-list-item-text>
              {{item}}
            </v-list-item-text>
          </v-list-item>
        ...
        <div class="expert-one-experts">
          ...
          <v-card v-for="(item, i) in employeeList" :key="i" v-if="employeeList.length">
            ...
            <v-card-actions>
              ...
              <p v-else>Not online</p>
              <!-- <v-btn color="primary" nuxt exact to="/calendar">
                <v-icon>
                  mdi-book
                </v-icon>
                Programeaza-te
