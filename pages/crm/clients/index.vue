                            ...
                            <v-card-text class="pa-0">
                                <v-data-table
                                    ...
                                    <tr v-if="item.userId">
                                        ...
                                        <td>
                                            <v-btn  outlined  fab dark color="primary" small :to="'/crm/history/client/' + item.userId._id">
                                                <v-icon>mdi-mail</v-icon>
                                            </v-btn>
                                        </td>
                                        <td>
                                            <v-btn depressed outlined icon fab dark color="primary" small :to="'/crm/clients/edit/' + item.userId._id">
