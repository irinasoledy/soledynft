...
router.get('/api/init', (req, res) => app.init(req, res) )

// router.post('/back/employees/create', (req, res) => employee.create(req, res) )

router.get('/api/users', (req, res) => UserController.getByType(req, res))
router.post('/api/user', (req, res) => UserController.create(req, res) )
router.delete('/api/:id/user', (req, res) => UserController.remove(req, res) )


// router.post('/back/employees/edit-info', (req, res) => employee.editInfo(req, res) )
router.patch('/api/:id/user', (req, res) => UserController.update(req, res) )
router.patch('/api/:id/user-avatar', (req, res) => UserController.updateAvatar(req, res) )
...
router.patch('/api/:id/user-status', (req, res) => UserController.updateStatus(req, res) )
...
router.get('/api/notifications', (req, res) => app.getNotifications(req, res))
...
router.get('/api/:id/history', (req, res) => history.getClientsList(req, res) )
