              ...
              <v-row class="justify-space-around">
                ...
                <v-col class="col-4 pb-0">
                  <div class="colProd__image">
                    <img :src="`https://back.soledynft.shop/images/products/sm/${product.product.main_image.src}`">
                  </div>
                </v-col>
                ...
                <v-col class="col-xl-8 col-lg-8 col-md-6 col-6 pb-0">
                  <div class="colProd__descr">
                    ...
                    <div class="colProd__price price">
                      ...
                      <span
                          v-if="product.product.personal_price.old_price > product.product.personal_price.price">/</span>
                      <span class="price__discount"
                            v-if="product.product.personal_price.old_price > product.product.personal_price.price">
                ...
                <div class="size__item" v-for="subproduct in product.product.subproducts" :key="subproduct.id">
                  <label class="size__radio">
                    <input type="radio" name="size" :value="subproduct.parameter_value.id"
                           @change="setSubproduct(product.product.id, subproduct.id)"/>
