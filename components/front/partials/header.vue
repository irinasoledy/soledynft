...
<v-card class="overflow-hidden">
    ...
    <v-app-bar
        ...
        <v-navigation-drawer
            ...
            <v-list nav light>
                <v-list-item-group>
                    <v-list-item v-for="service in servicesList" :key="service.id" @click.stop="openSubservices(service)">
                                ...
                                <v-expand-transition>
                                    <v-list
                                        ...
                                        <v-hover v-slot="{hover}" v-for="(item, i) in servicesList" :key="i">
                                            ...
                                            <v-list-item v-else :to="`/${language.lang}/service/${item.alias}/${item.alias}`">
                                                <v-list-item-title>
                                                    {{item.translation.name}}
                                                </v-list-item-title>
                                            </v-list-item>
